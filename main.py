...
df = pd.read_csv(r"C:\Users\HP\Desktop\DSAIML Course\1. Class Notes\1. Regular Class notes\C46 -05-06-25 - NLP project-1\MULTIPLE LANGUAGE TRANSLATION\language.csv")
